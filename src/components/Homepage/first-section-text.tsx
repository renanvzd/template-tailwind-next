    ...
    <div className="w-full h-full  flex justify-center mx-auto items-center">
      <div className="flex flex-col h-full">
        <div className="h-full pt-6 ">
          <div className="flex flex-col lg:mx-auto justify-center items-center lg:px-16 md:px-16 px-4 mx-6 border-b border-black pb-10 border-x-8 lg:w-[80%]">
        ...
        <div className="h-64 flex flex-col md:my-10 my-2">
